...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_BASE] = _LYOUT(
    KC_GESC,   KC_LCMD, KC_H, KC_D, KC_L, KC_C, KC_F, KC_RCMD, KC_GESC, KC_MINS, KC_EQL,            KC_PGUP, KC_1, KC_2, Y_ID75_M1,
    KC_TAB,    KC_LALT, KC_A, KC_E, KC_I, KC_O, KC_U, KC_RALT, KC_TAB,  KC_BSLS, KC_GRV,            KC_PGDN, KC_3, KC_4, Y_ID75_M2,
    KC_ENT,    KC_LCTL, KC_M, KC_N, KC_R, KC_S, KC_T, KC_RCTL, KC_ENT,  KC_SCLN, KC_LBRC,           KC_RBRC, KC_5, KC_6, Y_ID75_M3,
    KC_BSPC,   KC_LSFT, KC_P, KC_B, KC_J, KC_K, KC_G, KC_RSFT, KC_BSPC, KC_QUOT, KC_COMM,           KC_DOT,  KC_7, KC_8, Y_ID75_M4,
